...
# которая запрашивает год выпуска велосипеда и количество скоростей на нём и выводит
# на экран сообщение о том, подходит этот велик или нет. Год выпуска — не старше 2018-го,
# количество скоростей — не менее 24.
if __name__ == '__main__':
    speed = int(input('Введите количество скоростей: '))
    year = int(input('Введите год выпуска: '))
    if speed >= 2018 and speed >= 24:
        print('Подходит')
    else:
        print('Не подходит')
